...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2016 at 10:38 AM
...
INSERT INTO `account_holders` (`account_holder_id`, `account_holder_name`, `account_holder_fathersname`, `account_holder_mothersname`, `account_holder_birthdate`, `gender_type`, `account_holder_mobile`, `account_holder_email`, `document_name`, `document_number`, `account_type_name`, `primar _savings_amount`, `account_holder_present_address`, `account_holder_permanent__address`, `branch_name`, `verifier_name`, `nominee_name`, `account_holder_photo`) VALUES
(11111, 'Mahabub', 'Mahabub', 'Mahabub', '2001-09-24', 'male', 1234567, 's@gmail.com', 'nid', '46546465', 'saving', 500, 'mirpur', 'mirpur', 'dhaka', 'mizan', 'mizan', 'yes');
...
INSERT INTO `employees` (`employee_id`, `employee_name`, `employee_fathers_name`, `employee_mothers_name`, `employee_birth_date`, `gender_type`, `employee_mobile`, `employee_email`, `document_name`, `document_number`, `employee_present_address`, `employee_permanent_address`, `employee_joining_date`, `employee_designation`, `employee_salary`, `employee_photo`) VALUES
(1, 'm', 'm', 'm', '2016-07-20', 'm', '22', 'sdfsdf', 'dfd', 'fdfdf', 'dfdfd', 'dfd', '2016-07-30', 'dfdf', 556, 'dfd');
...
INSERT INTO `employee_salary` (`salary_id`, `employee_name`, `month_name`, `year_name`, `salary_ammount`, `salary_pay_date`) VALUES
(1, 'm', 'jan', 2015, 5000, '2016-07-30 10:29:00');
...
--
ALTER TABLE `account_holders`
  MODIFY `account_holder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11112;
--
